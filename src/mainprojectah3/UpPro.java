...
public class UpPro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Tcodigo.getText().isEmpty() && tnombre.getText().isEmpty()
            && Tdes.getText().isEmpty() && Tcantidad.getText().isEmpty()  ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     public void mostrar(int id)    {
        ...
        Tcodigo.setText(ProductList.Stock.get(id).getCodigo()+"");
        tnombre.setText(ProductList.Stock.get(id).getNombre()+"");
        Tdes.setText(ProductList.Stock.get(id).getDescription()+"");
        Tcantidad.setText(ProductList.Stock.get(id).getCantidad()+"");
        Tprecio.setText(ProductList.Stock.get(id).getPrecio()+"");
    ...
    public void update(int id)    {
        ...
        ProductList.Stock.set(contentP,( new ProductList(id,tnombre.getText(), Tdes.getText()
